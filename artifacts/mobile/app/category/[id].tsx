...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "#141414", borderRadius: 14, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 18, paddingVertical: 16, borderWidth: 1, borderColor: "#1f1f1f" },
  cardName: { fontSize: 16, fontFamily: "Inter_600SemiBold", color: "#ffffff", flex: 1 },
